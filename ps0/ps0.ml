...
let name : (string * string) = ("David", "None");;
...
let class_year : year = Other "No longer a student";;

(* 1.c. Replace the .... with what you're excited about in this course *)
let exciting : string = "I'm excited about learning a new form of programming and developing my overall skills to problem solve!";;
